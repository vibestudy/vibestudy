...
function FeedbackCard({ category, title, description, isFirst = false }: FeedbackCardData & { isFirst?: boolean }) {
  ...
  return (
    <div
      className={clsx(
        'flex flex-row items-stretch gap-1 self-stretch rounded-[14px] border p-1',
        isFirst ? 'border-[rgba(164,164,164,0.72)]' : 'border-[rgba(164,164,164,0.2)]'
      )}
    >
      <div className="flex flex-1 flex-col gap-2 self-stretch rounded-[10px] bg-[rgba(164,164,164,0.1)] p-3 dark:bg-[rgba(245,245,245,0.04)]">
        <div className="flex flex-row items-center gap-1 self-stretch p-1">
          <Image src={config.icon} alt="" width={16} height={16} className="opacity-56 invert dark:invert-0" />
          <span className="text-xs leading-[1.35] font-normal tracking-[-0.02em] text-[rgba(22,22,22,0.56)] dark:text-[rgba(245,245,245,0.56)]">
            {config.label}
          </span>
        </div>
        <div className="flex flex-col gap-0.5 self-stretch p-1">
          <h4 className="text-base leading-[1.5] font-medium tracking-[-0.02em] text-[#161616] dark:text-[#F5F5F5]">
            {title}
          </h4>
          <p className="text-sm leading-[1.45] font-normal tracking-[-0.02em] text-[rgba(22,22,22,0.72)] dark:text-[rgba(245,245,245,0.72)]">
            {description}
          </p>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col gap-3 self-stretch">
      <div className="flex flex-row items-stretch gap-0.5 self-stretch p-1">
        <h3 className="flex-1 text-lg leading-[1.45] font-medium tracking-[-0.02em] text-[#161616] dark:text-[#F5F5F5]">
          {title}
        </h3>
      </div>
...
export function FeedbackPanelV2({ taskTitle, suggestions, onClose, onPrevious, onNext }: FeedbackPanelV2Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center self-stretch rounded-2xl bg-[rgba(255,255,255,0.72)] shadow-[0_0_24px_0_rgba(22,22,22,0.06)] dark:bg-[rgba(255,255,255,0.04)]">
      <div className="flex flex-row items-center gap-2.5 self-stretch p-5">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="text-base leading-[1.5] font-normal tracking-[-0.02em] text-[rgba(22,22,22,0.72)] dark:text-[rgba(245,245,245,0.72)]">
            {taskTitle}
          </span>
        </div>
        <Image
          ...
          width={16}
          height={16}
          className="opacity-72 invert dark:invert-0"
        />
        <div className="flex flex-row items-center gap-2">
          <Image src="/icons/wand-shine.svg" alt="" width={24} height={24} className="invert dark:invert-0" />
          <span className="text-base leading-[1.5] font-medium tracking-[-0.02em] text-[#161616] dark:text-[#F5F5F5]">
            채점 후 피드백
          </span>
        </div>
      </div>
      ...
      <div className="relative flex flex-1 flex-col items-center gap-10 self-stretch px-5 pt-2 pb-5">
        ...
        <div className="absolute bottom-5 left-1/2 flex -translate-x-1/2 flex-row items-center gap-1 rounded-full border border-[rgba(164,164,164,0.2)] bg-white p-1 shadow-[0_0_24px_0_rgba(22,22,22,0.06)] backdrop-blur-[16px] dark:bg-[#161616]">
          <button
            type="button"
            onClick={onClose}
            className="flex flex-row items-center justify-center gap-1.5 rounded-full bg-[#161616] px-3 py-3 dark:bg-[#F5F5F5]"
          >
            <Image src="/icons/close.svg" alt="" width={20} height={20} className="size-3 invert dark:invert-0" />
            <span className="text-sm leading-[1.45] font-medium tracking-[-0.02em] text-[#F5F5F5] dark:text-[#161616]">
              피드백 종료
            </span>
          </button>
